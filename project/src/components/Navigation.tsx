    ...
    <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 lg:space-x-8 items-center">
          ...
          <div className="px-4 py-1.5 sm:px-6 sm:py-2 bg-gray-400 rounded-full text-white font-semibold text-sm sm:text-base">
            Registration Closed
          </div>
        </div>
        ...
        <div className="md:hidden flex items-center">
          <div className="mr-3 px-4 py-1.5 bg-gray-400 rounded-full text-white font-semibold text-sm">
            Registration Closed
          </div>
          <button 
