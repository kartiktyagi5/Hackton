                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  <div className="flex items-center">
                    ...
                    <p className="ml-2 text-sm text-gray-500">
                      <span className="font-medium text-gray-900">Premium</span> opportunities
                    </p>
                  </div>
                </div>
              </div>
        ...
        >
          <div className="inline-flex px-6 py-3 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full">
            <p className="text-sm font-medium text-gray-700">
              <span className="text-blue-600">All participants</span> will receive certificates and access to exclusive resources
            </p>
          </div>
        </motion.div>
      </div>
